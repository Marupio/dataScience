...
int main() {
    ...
    for (int i = 0; i < nIters; ++i) {
        ...
        short res = HandRanker::compare2(bd, pktA, pktB);
        if (res >= 0) {
            std::cout << " ** ";
        } else {
            std::cout << "    ";
        }
        HandRanker::HandType2 htsA(HandRanker::getHandType2(bd, pktA));
        std::cout << pktA << ": "
        ...
        HandRanker::HandType2 htsB(HandRanker::getHandType2(bd, pktB));
        std::cout << pktB << ": "
